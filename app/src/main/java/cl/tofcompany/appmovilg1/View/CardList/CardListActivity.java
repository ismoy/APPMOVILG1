package cl.tofcompany.appmovilg1.View.CardList;
...
import cl.tofcompany.appmovilg1.Presenter.CardList.CardListPresenter;
...
public class CardListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigation();
/*
        CardListPresenter presenter = new CardListPresenter(this);
        presenter.ShowPres(cardListBinding.recyclerview,cardListBinding.scrollView4, cardListBinding.totalFeeTxt, cardListBinding.taxTxt, cardListBinding.deliveryTxt, cardListBinding.totalTxt, cardListBinding.emptyTxt,cardListBinding.pagar,cardListBinding.cardBtn,cardListBinding.homeBtn);*/
    }
